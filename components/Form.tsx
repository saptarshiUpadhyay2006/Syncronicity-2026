...
//         <button
//           type="submit"
//           className="flex items-center gap-2 rounded-full bg-[#42a7d6] px-6 py-2 text-white text-sm font-semibold shadow-md hover:bg-[#0284c7] active:scale-95 transition">
//           Send
